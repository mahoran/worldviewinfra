...
$resourceGroupName = "rgAdmin"  #TODO: Update this variable value
$customScriptExtensionStorageAccountName = "worldviewartf02" #TODO: Update this variable value
...
$filePath = "$($scriptDir)\setupftpserver.ps1"
