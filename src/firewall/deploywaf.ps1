#This is who you can invoke this script to provision COM Web Prod Firewalls
#
# .\deployprodcomwebwaf.ps1 -ResourceGroupLocation "centralus" -ArtifactStagingDirectory templates -StorageAccountName worldviewartf01 -ResourceGroupName rgCOM-APPFW-CENTRAL -StorageContainerName prodcomwaf -UploadArtifacts
#
#######################################################################################
...
if ($DebugOutput) {
$OptionalParameters.Add('Debug', $true)
}
...
if ($ValidateOnly) {
    ...
    Write-Output ("=============================== Option args are ==============================================")
    Write-Output ($OptionalParameters | Out-String) 
    Write-Output ("=============================== Template args are ==============================================")
    Write-Output ($TemplateArgs | Out-String | FT) 
